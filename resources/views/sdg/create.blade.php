            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{route('sdg.store')}}" method="post" enctype="multipart/form-data">
                            @if(session('message'))
                                <script>
                            ...
                            <div class="card-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" value="{{old('title')}}" name="goal" class="form-control" id="goal" placeholder="Enter Goal">
                                    @error('goal')
