                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-danger">
                        <div class="card-header">
                            <h3 class="card-title">Create Success Story</h3>
                             <a href="{{route('succesStory.index')}}" class="btn btn-sm btn-white float-right"> <i class="fa-solid fa-arrow-left"></i>  Back  </a>
                        </div>

                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{route('succesStory.store')}}" method="post" enctype="multipart/form-data">
                            @if(session('message'))
                                <script>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="img" value="{{old('file')}}" class="form-control" id="">
                                        </div>
