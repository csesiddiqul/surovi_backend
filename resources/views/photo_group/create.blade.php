                ...
                <div class="col-md-12">
                    <!-- general form elements -->
                       ...
                       <div class="card-header">
                            <h3 class="card-title">Create Photo Group</h3>
                             <a href="{{route('photogroup.index')}}" class="btn btn-sm btn-white float-right"> <i class="fa-solid fa-arrow-left"></i>  Back  </a>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{route('photogroup.store')}}" method="post" enctype="multipart/form-data">
                            @if(session('message'))
                                <script>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{old('group_name')}}" name="groupName" class="form-control" id="exampleInputTitle" placeholder="Enter Title">
                                    @error('groupName')
