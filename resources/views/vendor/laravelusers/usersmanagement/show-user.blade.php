                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-3 col-sm-4 col-md-4 col-lg-3">
                                {!! Form::open(array('url' => 'users/' . $user->id, 'class' => 'form-inline')) !!}
                                    ...
                                    {!! Form::button(trans('laravelusers::laravelusers.buttons.delete-user'), array('class' => 'btn btn-danger btn-md btn-block','type' => 'submit', 'data-toggle' => 'modal', 'data-target' => '#confirmDele', 'data-title' => 'Delete User', 'data-message' => 'Are you sure you want to delete this user?')) !!}
                                {!! Form::close() !!}
                            </div>
                        </div>
