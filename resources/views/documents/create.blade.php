                    ...
                    <div class="card card-danger">
                       ...
                       <div class="card-header">
                            <h3 class="card-title">Create Documents</h3>
                             <a href="{{route('documents.index')}}" class="btn btn-sm btn-white float-right"> <i class="fa-solid fa-arrow-left"></i>  Back  </a>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{route('documents.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" value="{{old('date')}}" name="date" class="form-control" id="exampleInputTitle" placeholder="Enter priority">
                                    @error('date')
                                    <span class="note-help-block text-danger">
                                            <strong>{{$message}}</strong>
                                        </span>
