                      ...
                      <div class="card card-danger">
                       ...
                       <div class="card-header">
                            <h3 class="card-title">Create Job Application</h3>
                             <a href="{{route('JobApplication.index')}}" class="btn btn-sm btn-white float-right"> <i class="fa-solid fa-arrow-left"></i>  Back  </a>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{route('JobApplication.store')}}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputTitle">Job Title</label>
