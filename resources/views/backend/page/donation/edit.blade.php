...
@section('title') Donation Edit - Admin-Panel @endsection
@section('content')
      ...
      <div class="row">
        <div class="col-12">
          <div class="card card-primary">
            <form class="form p-2" action="{{route('donations.update', $donation->id)}}" method="post"  enctype="multipart/form-data">
            @csrf
            @method('PATCH')
              <div class="card-body">
                  <div class="d-flex justify-content-between mb-2">
                    ...
                    <div class="">
                      <a href="{{Route('donations.index')}}">
                        <i class="material-icons text-white rounded-circle bg-primary p-1">Back</i>
                    </a>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-12 col-md-9">
                      <input type="text" name="title" id="title" value="{{$donation->title}}" class="form-control">
                      @error('title')
                  ...
                  <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-4">
                      <div class="img-views">
                        <img src="{{asset('backend/img/donation')}}/{{$donation->image}}" alt="" class="img-fluid input-preview" width="300">
                        </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-9">
                        <textarea class="form-control" name="description" id="description" rows="5">{{$donation->description}}</textarea>
                        @error('description')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                  ...
                  <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-9">
                        <select class="form-control selectric rounded" name="status" id="status" required>
                            ...
                            <option value="2" {{$donation->status == 2 ? 'selected':''}}>De-Active</option>
                        </select>
                        @error('status')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                  ...
                  <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-9">
                        <input type="number" name="priority" id="priority" value="{{$donation->priority}}" class="form-control">
                    </div>
                  </div>
